    ...
    <div class="hero-emblem" id="hero-emblem" role="button" tabindex="0" aria-label="Spin the emblem and scroll to Publications">
      <div class="emblem-stack">
        ...
        <svg class="emblem-ring" viewBox="0 0 900 912" aria-hidden="true">
          ...
          <path d="M 143.5 792.4 A 458.0 458.0 0 0 1 143.5 111.6 L 166.3 136.9 A 424.0 424.0 0 0 0 166.3 767.1 Z"></path>
          <path d="M 136.8 104.2 L 187.7 97.5 L 173.0 144.3 Z"></path>
          <path d="M 308.5 16.4 A 458.0 458.0 0 0 1 898.0 356.8 L 864.7 363.8 A 424.0 424.0 0 0 0 319.0 48.8 Z"></path>
          <path d="M 907.8 354.7 L 888.2 402.1 L 855.0 365.9 Z"></path>
        </svg>
      </div>
    </div>
    <div class="hero-copy">
